...
KPI_TOOLTIP_DEFINITIONS = {
    ...
    "Incident Detail Quality": "Percent of critical details provided with Incidents including: Description, Distribution Members, Hazard, Contributing Behavior & Conditions, Closed status.",
    ...
    "Budgets Create Date": "Avg Date of Budget Line Item creation as percent of Project Lifecycle.",
    ...
    "Daily Logs % with Issues": "Percent of Daily Logs noting a problem (Accident, Delays, Weather Conditions, Safety Violations).",
    "Daily Logs Avg Create Date": "Avg Date of Daily Log creation as percent of Project Lifecycle.",
    "Daily Logs Avg Days until Created": "Avg number of days delay until Daily Log is created.",
    "Daily Logs Rate": "Number of Daily Logs divided by number of Project Days.",
    "Meetings Documentation Quality": "Percent of critical details provided with Meetings including: Attendees, Item Count, Location, Meeting Date, Overview/Title, Attachments.",
...
def display_kpi_table(kpi_df):
    ...
    # Inject tooltip CSS with cache-busting
    import time
    cache_buster = int(time.time())
    css_with_cache_buster = TOOLTIP_CSS.replace('<style>', f'<style>/* cache-buster: {cache_buster} */')
    st.markdown(css_with_cache_buster, unsafe_allow_html=True)
